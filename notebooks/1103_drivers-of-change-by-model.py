...
def transform_ar6_workflow_output_to_iamc_variable(v):
    ...
    direct_replacements = (
        ("HFC245ca", "HFC245fa"),
        ("Emissions|CCl4", "Emissions|Montreal Gases|CCl4"),
        ("Emissions|CFC11", "Emissions|Montreal Gases|CFC|CFC11"),
        ("Emissions|CFC12", "Emissions|Montreal Gases|CFC|CFC12"),
        ("Emissions|CFC113", "Emissions|Montreal Gases|CFC|CFC113"),
        ("Emissions|CFC114", "Emissions|Montreal Gases|CFC|CFC114"),
        ("Emissions|CFC115", "Emissions|Montreal Gases|CFC|CFC115"),
        ("Emissions|CH2Cl2", "Emissions|Montreal Gases|CH2Cl2"),
        ("Emissions|CH3Br", "Emissions|Montreal Gases|CH3Br"),
        ("Emissions|CH3CCl3", "Emissions|Montreal Gases|CH3CCl3"),
        ("Emissions|CH3Cl", "Emissions|Montreal Gases|CH3Cl"),
        ("Emissions|CHCl3", "Emissions|Montreal Gases|CHCl3"),
        ("Emissions|HCFC141b", "Emissions|Montreal Gases|HCFC141b"),
        ("Emissions|HCFC142b", "Emissions|Montreal Gases|HCFC142b"),
        ("Emissions|HCFC22", "Emissions|Montreal Gases|HCFC22"),
        ("Emissions|Halon1202", "Emissions|Montreal Gases|Halon1202"),
        ("Emissions|Halon1211", "Emissions|Montreal Gases|Halon1211"),
        ("Emissions|Halon1301", "Emissions|Montreal Gases|Halon1301"),
        ("Emissions|Halon2402", "Emissions|Montreal Gases|Halon2402"),
    )
