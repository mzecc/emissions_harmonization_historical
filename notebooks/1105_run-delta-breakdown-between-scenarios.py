...
# %% [markdown]
# - attribution to each label
# - stacked bar plot showing the contribution of different species to the delta between scenarios (also requires calculating residual)
